 ...
 * @version 1.8
 * @date 2021-09-08
 * @brief Peripheral Access Layer for S32K344_eDMA
 *
...
#if !defined(S32K344_eDMA_H_)  /* Check if memory map has not been already included */
#define S32K344_eDMA_H_
...
#endif  /* #if !defined(S32K344_eDMA_H_) */
