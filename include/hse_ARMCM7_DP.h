...
#ifndef HSE_ARMCM7_DP_H
#define HSE_ARMCM7_DP_H
...
#include "hse_core_cm7.h"                       /* Processor and core peripherals */
#include "hse_system_ARMCM7.h"                  /* System Header */
