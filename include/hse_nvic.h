...
*                                       DEFINES AND MACROS
==================================================================================================*/
#define HSE_NVIC_BASEADDR 0xE000E100
#define HSE_NVIC_ISER_OFFSET(id) (uint8)((id >> 5) << 2)
#define HSE_NVIC_ICER_OFFSET(id) (0x80 + (uint8)((id >> 5) << 2))
#define HSE_NVIC_IPRO_OFFSET(id) (0x300 + (uint8)((id >> 2) << 2))
#define HSE_NVIC_IPRO_MASK(id) (uint32)(0xFF << ((id % 4)*8))

/* S32_SCB - Peripheral instance base addresses */
/* Skip S32_SCB definitions if NXP RTD SDK already defined them */
#ifndef S32_SCB_BASE
