 ...
 ******************************************************************************/
#define FLASH_WriteXPEADR(dst)  do{ IP_PFLASH->PFCPGM_XPEADR_L=(uint32_t)dst; }while(0)
 ...
 * @note    Implemented as a macro.
 ******************************************************************************/
#define FLASH_GetXPEID()  ((IP_FLASH->XMCR&FLASH_XMCR_XPEID_MASK)>>FLASH_XMCR_XPEID_SHIFT)
...
#define FLASH_GetXStatus()                                                    \
  (tFLASH_XSTATUS)(IP_FLASH->XMCR&(FLASH_XWDI_ST|FLASH_XDOK_ST|FLASH_XPEG_ST|FLASH_XDONE_ST))
 ...
 * @note    Implemented as a macro.
 ******************************************************************************/
#define FLASH_WritePEADR(dst)  do{ IP_PFLASH->PFCPGM_PEADR_L=(uint32_t)dst; }while(0)
 ...
 * @note    Implemented as a macro.
 ******************************************************************************/
#define FLASH_GetPEID()  ((IP_FLASH->MCR&FLASH_MCR_PEID_MASK)>>FLASH_MCR_PEID_SHIFT)
 ...
 * @note    Implemented as a macro.
 ******************************************************************************/
#define FLASH_GetStatus()  (tFLASH_STATUS)IP_FLASH->MCRS
 ...
 * @note    Implemented as a macro.
 ******************************************************************************/
#define FLASH_ClrStatus(mask)  do{ IP_FLASH->MCRS=mask; }while(0)
...
#define FLASH_ConfigWatchdog(mode)                                            \
    REG_RMW32(IP_FLASH_ALT->AMCR,FLASH_AMCR_WDD_MASK|FLASH_AMCR_WDT_MASK,((mode)<<FLASH_AMCR_WDD_SHIFT))
