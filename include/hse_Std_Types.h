...
#ifndef HSE_STD_TYPES_H
#define HSE_STD_TYPES_H
...
*/
//#define HSE_DISABLE_MCAL_INTERMODULE_ASR_CHECK
//#define HSE_PLATFORM_AR_RELEASE_MAJOR_VERSION  4
#define HSE_STD_VENDOR_ID                     43
/*
 * @violates @ref Std_Types_h_REF_2 This is required as per autosar Requirement, 
 */
#define HSE_STD_AR_RELEASE_MAJOR_VERSION      4
/*
 * @violates @ref Std_Types_h_REF_2 This is required as per autosar Requirement, 
 */
#define HSE_STD_AR_RELEASE_MINOR_VERSION      2
/*
 * @violates @ref Std_Types_h_REF_2 This is required as per autosar Requirement, 
 */
#define HSE_STD_AR_RELEASE_REVISION_VERSION   2
#define HSE_STD_SW_MAJOR_VERSION              0
#define HSE_STD_SW_MINOR_VERSION              4
#define HSE_STD_SW_PATCH_VERSION              0
...
#if ((HSE_STD_AR_RELEASE_MAJOR_VERSION != HSE_PLATFORM_AR_RELEASE_MAJOR_VERSION) || (HSE_STD_AR_RELEASE_MINOR_VERSION != HSE_PLATFORM_AR_RELEASE_MINOR_VERSION))
...
#if ((HSE_STD_AR_RELEASE_MAJOR_VERSION != HSE_COMPILER_AR_RELEASE_MAJOR_VERSION) || \
    (HSE_STD_AR_RELEASE_MINOR_VERSION != HSE_COMPILER_AR_RELEASE_MINOR_VERSION))
    #error "AutoSar Version Numbers of Std_Types.h and Compiler.h are different"
#endif
#endif

/* Skip duplicate definitions if NXP RTD Std_Types.h was already included */
...
*/
#ifndef HSE_STATUSTYPEDEFINED
    #define HSE_STATUSTYPEDEFINED
    /**
...
#endif /* !defined(STD_TYPES_H) */

#endif /* #ifndef HSE_STD_TYPES_H */
