...
==================================================================================================*/
#ifndef HSE_FLS_REGISTERS_H
#define HSE_FLS_REGISTERS_H

#include "hse_Platform_Types.h"
#include "hse_StdRegMacros.h"

/*************************************************************************/
/*    Defining Main Registers for both FLASH and PFLASH             */
/*************************************************************************/
...
#define PFLASH_PFCBLK1_LOCKMASTER_S0_ADDR32     ((uint32)(PFLASH_BASEADDR + (uint32)0x3E0UL)) /**< @brief  Block a Lock Master Sectorb  */
#define PFLASH_PFCBLK2_LOCKMASTER_S0_ADDR32     ((uint32)(PFLASH_BASEADDR + (uint32)0x400UL)) /**< @brief  Block a Lock Master Sectorb  */
#define PFLASH_PFCBLK3_LOCKMASTER_S0_ADDR32     ((uint32)(PFLASH_BASEADDR + (uint32)0x420UL)) /**< @brief  Block a Lock Master Sectorb  */
