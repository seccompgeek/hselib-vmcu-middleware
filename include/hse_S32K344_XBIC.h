...
#define IP_XBIC_BASE_ADDRS                       { IP_XBIC_AXBS_BASE, IP_XBIC_AXBS_EDMA_BASE, IP_XBIC_AXBS_PERI_BASE, IP_XBIC_AXBS_TCM_BASE }
/** Array initializer of XBIC peripheral base pointers */
#define IP_XBIC_BASE_PTRS                        { IP_XBIC_AXBS, IP_XBIC_AXBS_EDMA, IP_XBIC_AXBS_PERI, IP_XBIC_AXBS_TCM }
