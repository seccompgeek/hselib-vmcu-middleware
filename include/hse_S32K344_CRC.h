 ...
 * @version 1.8
 * @date 2021-09-08
 * @brief Peripheral Access Layer for S32K344_CRC
 *
...
#if !defined(S32K344_CRC_H_)  /* Check if memory map has not been already included */
#define S32K344_CRC_H_
...
#define IP_CRC_BASE                              (0x40380000u)
...
#endif  /* #if !defined(S32K344_CRC_H_) */
