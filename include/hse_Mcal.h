...
==================================================================================================*/
#define HSE_MCAL_VENDOR_ID                    43
#define HSE_MCAL_MODULE_ID                    0
/*
 * @violates @ref Mcal_h_REF_3 This is required as per autosar Requirement, 
 */
#define HSE_MCAL_AR_RELEASE_MAJOR_VERSION     4
/*
 * @violates @ref Mcal_h_REF_3 This is required as per autosar Requirement, 
 */
#define HSE_MCAL_AR_RELEASE_MINOR_VERSION     2
/*
 * @violates @ref Mcal_h_REF_3 This is required as per autosar Requirement, 
 */
#define HSE_MCAL_AR_RELEASE_REVISION_VERSION  2
#define HSE_MCAL_SW_MAJOR_VERSION             0
#define HSE_MCAL_SW_MINOR_VERSION             4
#define HSE_MCAL_SW_PATCH_VERSION             0
...
==================================================================================================*/
    ...
    #if ((HSE_MCAL_AR_RELEASE_MAJOR_VERSION != HSE_COMPILER_AR_RELEASE_MAJOR_VERSION) || \
         (HSE_MCAL_AR_RELEASE_MINOR_VERSION != HSE_COMPILER_AR_RELEASE_MINOR_VERSION))
    ...
    #if ((HSE_MCAL_AR_RELEASE_MAJOR_VERSION != HSE_STD_AR_RELEASE_MAJOR_VERSION) || \
         (HSE_MCAL_AR_RELEASE_MINOR_VERSION != HSE_STD_AR_RELEASE_MINOR_VERSION))
    ...
    #if ((HSE_MCAL_AR_RELEASE_MAJOR_VERSION != HSE_SOC_IPS_AR_RELEASE_MAJOR_VERSION) || \
         (HSE_MCAL_AR_RELEASE_MINOR_VERSION != HSE_SOC_IPS_AR_RELEASE_MINOR_VERSION))
...
*                                         CONSTANTS
==================================================================================================*/
#define HSE_MCAL_ARM_MARCH      (16)  /* for ARM M4 Thumb2 */
#define HSE_MCAL_ARM_AARCH32    (32)  /* for ARM ARCH32    */
#define HSE_MCAL_ARM_AARCH64    (64)  /* for ARM ARCH64    */

/*==================================================================================================
*                                      DEFINES AND MACROS
==================================================================================================*/
#ifdef HSE_MCAL_ENABLE_USER_MODE_SUPPORT
#ifdef HSE_AUTOSAR_OS_NOT_USED
...
#endif /* HSE_AUTOSAR_OS_NOT_USED */
#endif /* HSE_MCAL_ENABLE_USER_MODE_SUPPORT */
    

/* ARM_MARCH - is used to specify the ARM architecture MCAL_MARCH, MCAL_AARCH32, MCAL_AARCH64 */
/** @violates @ref Mcal_h_REF_5 C macros shall only expand to a braced initialiser, a constant, a parenthesised expression */
#define HSE_MCAL_PLATFORM_ARM  HSE_MCAL_ARM_MARCH
 /**************************************** Green Hills *********************************************/
    ...
    */
    #ifdef HSE_MCAL_ENABLE_FAULT_INJECTION
        /**  @violates @ref Mcal_h_REF_1 A function should be used in preference to a function-like macro. */
        /** @violates @ref Mcal_h_REF_5 C macros shall only expand to a braced initialiser, a constant, a parenthesised expression */
        /** @violates @ref Mcal_h_REF_7 The # and ## preprocessor operators should not be used. */
        #define HSE_MCAL_PUT_IN_QUOTES(x) #x
        /**  @violates @ref Mcal_h_REF_1 A function should be used in preference to a function-like macro. */
        /** @violates @ref Mcal_h_REF_5 C macros shall only expand to a braced initialiser, a constant, a parenthesised expression */
        /** @violates @ref Mcal_h_REF_6 Parameter not enclosed in parentheses */
        #define HSE_MCAL_FAULT_INJECTION_POINT(label) ASM_KEYWORD(HSE_MCAL_PUT_IN_QUOTES(label::))
    #else
        /**  @violates @ref Mcal_h_REF_1 A function should be used in preference to a function-like macro. */
        /** @violates @ref Mcal_h_REF_5 C macros shall only expand to a braced initialiser, a constant, a parenthesised expression */
        #define HSE_MCAL_FAULT_INJECTION_POINT(label)
    #endif
...
/**************************************** IAR *********************************************/
    ...
    */
    /**  @violates @ref Mcal_h_REF_1 A function should be used in preference to a function-like macro. */
    /** @violates @ref Mcal_h_REF_5 C macros shall only expand to a braced initialiser, a constant, a parenthesised expression */
    #define HSE_MCAL_PUT_IN_QUOTES1(x) HSE_MCAL_PUT_IN_QUOTES(x)
    ...
    * parameter shall be enclosed in parentheses
    */
    #define VAR_ALIGN(v, size)  _Pragma(HSE_MCAL_PUT_IN_QUOTES1(data_alignment=size)) \
                                v;
    /**
    * @brief Compiler abstraction for the data alignment
    */
...
/* check that the compiler used is supported (otherwise some defines might not exist) */
...
#if defined(HSE_AUTOSAR_OS_NOT_USED)
    #if defined (HSE_USE_SW_VECTOR_MODE)
        /**
    ...
    * a constant, a parenthesised expression
    */
    #if(HSE_MCAL_ARM_AARCH64 == HSE_MCAL_PLATFORM_ARM)
        /* for AARCH64 bit */
        /** @violates @ref Mcal_h_REF_1 A function should be used in preference to a function-like macro.    */
        /** @violates @ref Mcal_h_REF_5 C macros shall only expand to a braced initialiser, a constant, a parenthesised expression */
        ...
        /** @violates @ref Mcal_h_REF_1 A function should be used in preference to a function-like macro.    */
        /** @violates @ref Mcal_h_REF_5 C macros shall only expand to a braced initialiser, a constant, a parenthesised expression */
        #ifdef HSE_MCAL_USER_MODE_SUPPORT_ENABLED
        ...
        #endif /* HSE_MCAL_USER_MODE_SUPPORT_ENABLED */
    #endif 
    /**
...
==================================================================================================*/
/* Skip if NXP RTD Mcal.h already defined this type */
#if !defined(MCAL_H)
/**
