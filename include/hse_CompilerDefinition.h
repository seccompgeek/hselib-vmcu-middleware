...
#ifndef HSE_COMPILERDEFINITION_H
#define HSE_COMPILERDEFINITION_H
...
@{
*/
#define HSE_COMPILERDEFINITION_VENDOR_ID                      43
/*
 * @violates @ref CompilerDefinition_h_REF_5 This is required as per autosar Requirement,
 */
#define HSE_COMPILERDEFINITION_AR_RELEASE_MAJOR_VERSION       4
/*
 * @violates @ref CompilerDefinition_h_REF_5 This is required as per autosar Requirement,
 */
/** @violates @ref CompilerDefinition_h_REF_6 The compiler/linker shall be checked to ensure that 31 character
* significance and case sensitivity are supported for external identifiers */
#define HSE_COMPILERDEFINITION_AR_RELEASE_MINOR_VERSION       2
/*
 * @violates @ref CompilerDefinition_h_REF_5 This is required as per autosar Requirement,
 */
/** @violates @ref CompilerDefinition_h_REF_6 The compiler/linker shall be checked to ensure that 31 character
* significance and case sensitivity are supported for external identifiers */
#define HSE_COMPILERDEFINITION_AR_RELEASE_REVISION_VERSION    2
#define HSE_COMPILERDEFINITION_SW_MAJOR_VERSION               0
#define HSE_COMPILERDEFINITION_SW_MINOR_VERSION               4
#define HSE_COMPILERDEFINITION_SW_PATCH_VERSION               0
/**@}*/
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
#endif /* #ifndef HSE_COMPILERDEFINITION_H */
