...
#ifndef HSE_HOST_FLASHSRV_H
#define HSE_HOST_FLASHSRV_H
/*=============================================================================
 *                                 INCLUDE FILES
 =============================================================================*/
#include <stdint.h>
...
#define HSE_HOST_DATA_FLASH_MEMORY                              ((MEMORY_TYPE)0x01U)
#define HSE_HOST_BLOCK0_CODE_MEMORY                             ((MEMORY_TYPE)0x02U)
#define HSE_HOST_BLOCK1_CODE_MEMORY                             ((MEMORY_TYPE)0x03U)
#define HSE_HOST_BLOCK2_CODE_MEMORY                             ((MEMORY_TYPE)0x04U)
#define HSE_HOST_BLOCK3_CODE_MEMORY                             ((MEMORY_TYPE)0x05U)
...
#define HSE_HOST_BLK0_FLASH_MEMORY_LOGICAL_ADDR                 (APP_DATA_FLASH_MEMORY_LOGICAL_ADDR+\
                                                            SIZE_OF_BLOCK(DataF_Sector_Array))

#define HSE_HOST_BLK1_FLASH_MEMORY_LOGICAL_ADDR                 (HSE_HOST_BLK0_FLASH_MEMORY_LOGICAL_ADDR+\
                                                            SIZE_OF_BLOCK(Block0_Sector_Array))
 
#define HSE_HOST_BLK2_FLASH_MEMORY_LOGICAL_ADDR                 (HSE_HOST_BLK1_FLASH_MEMORY_LOGICAL_ADDR+\
                                                            SIZE_OF_BLOCK(Block1_Sector_Array))
 
#define HSE_HOST_BLK3_FLASH_MEMORY_LOGICAL_ADDR                 (HSE_HOST_BLK2_FLASH_MEMORY_LOGICAL_ADDR+\
...
#define HSE_HOST_BLOCK0_MEMORY_PHYSICAL_END_ADDR                (CODE_FLASH_BLOCK_1 - 1U)
#define HSE_HOST_BLOCK1_MEMORY_PHYSICAL_END_ADDR                (CODE_FLASH_BLOCK_2 - 1U)
#define HSE_HOST_BLOCK2_MEMORY_PHYSICAL_END_ADDR                (CODE_FLASH_BLOCK_3 - 1U)
#define HSE_HOST_BLOCK3_MEMORY_PHYSICAL_END_ADDR                (CODE_FLASH_BLOCK_4 - 1U)
...
#define HSE_HOST_BLOCK0_MEMORY_PHYSICAL_START_ADDR              ((GET_PHYSICAL_START_ADDRESS(HSE_HOST_BLOCK0_MEMORY_PHYSICAL_END_ADDR,Block0_Sector_Array)))
#define HSE_HOST_BLOCK1_MEMORY_PHYSICAL_START_ADDR              ((GET_PHYSICAL_START_ADDRESS(HSE_HOST_BLOCK1_MEMORY_PHYSICAL_END_ADDR,Block1_Sector_Array)))
#define HSE_HOST_BLOCK2_MEMORY_PHYSICAL_START_ADDR              ((GET_PHYSICAL_START_ADDRESS(HSE_HOST_BLOCK2_MEMORY_PHYSICAL_END_ADDR,Block2_Sector_Array)))
#define HSE_HOST_BLOCK3_MEMORY_PHYSICAL_START_ADDR              ((GET_PHYSICAL_START_ADDRESS(HSE_HOST_BLOCK3_MEMORY_PHYSICAL_END_ADDR,Block3_Sector_Array)))
