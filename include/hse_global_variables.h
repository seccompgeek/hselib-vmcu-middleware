...
#ifndef HSE_GLOBAL_VARIABLES_H
#define HSE_GLOBAL_VARIABLES_H
...
#include "hse_demo_app_services.h"
   ...
   // extern volatile eHSEFWAttributes gEnableIVTAuthBit;
    ...
    /* NOTE: KeyReadSrvResponse is a local variable in hse_secure_boot.c, NOT a global */
    ...
    /**< @brief AES CMAC key handle (moved from hse_config.c) */
    extern hseKeyHandle_t aesCmacKeyHandle;
    /**< @brief AES NVM key handle (moved from hse_config.c) */
    extern hseKeyHandle_t AesNVMKeyHandle;

    /**< @brief HSE FW install test status (moved from hse_demo_app_config.c) */
    extern volatile fwteststatus_t gInstallHSEFwTest;
    /**< @brief HSE capabilities buffer (moved from hse_demo_app_config.c) */
    extern volatile uint8_t ghseCapabilites[8];

    /**< @brief secure boot type (default: USE_BASIC_SECURE_BOOT) */
    extern volatile uint8_t gRunSecureBootType;
    /**< @brief Programmed application debug key (ADKP) */
    extern volatile uint8_t programmed_appdebugkey[16];
    /**< @brief ADKP hash buffer */
