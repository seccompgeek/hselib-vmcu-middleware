...
static const uint32_t LogicalStartAddressMemoryType[MEMORY_TYPE_MAX] =
{
    ...
    HSE_HOST_BLK0_FLASH_MEMORY_LOGICAL_ADDR,
    HSE_HOST_BLK1_FLASH_MEMORY_LOGICAL_ADDR,
    HSE_HOST_BLK2_FLASH_MEMORY_LOGICAL_ADDR,
    HSE_HOST_BLK3_FLASH_MEMORY_LOGICAL_ADDR,
};
static const uint32_t PhysicalEndAddressMemoryType[MEMORY_TYPE_MAX] =
{
    ...
    HSE_HOST_BLOCK0_MEMORY_PHYSICAL_END_ADDR,
    HSE_HOST_BLOCK1_MEMORY_PHYSICAL_END_ADDR,
    HSE_HOST_BLOCK2_MEMORY_PHYSICAL_END_ADDR,
    HSE_HOST_BLOCK3_MEMORY_PHYSICAL_END_ADDR,
};
static const uint32_t PhysicalStartAddressMemoryType[MEMORY_TYPE_MAX] =
{
    ...
    HSE_HOST_BLOCK0_MEMORY_PHYSICAL_START_ADDR,
    HSE_HOST_BLOCK1_MEMORY_PHYSICAL_START_ADDR,
    HSE_HOST_BLOCK2_MEMORY_PHYSICAL_START_ADDR,
    HSE_HOST_BLOCK3_MEMORY_PHYSICAL_START_ADDR,
