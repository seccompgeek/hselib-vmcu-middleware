...
#define LPUART_UART_IP_CFG_SW_MAJOR_VERSION              6
...
#if (LPUART_UART_IP_CFG_VENDOR_ID != LPUART_UART_IP_SA_VS_0_PBCFG_VENDOR_ID)
    #error "Lpuart_Uart_Ip_Cfg.h and Lpuart_Uart_Ip_Sa_VS_0_PBcfg.h have different vendor ids"
#endif
#if ((LPUART_UART_IP_CFG_AR_RELEASE_MAJOR_VERSION    != LPUART_UART_IP_SA_VS_0_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (LPUART_UART_IP_CFG_AR_RELEASE_MINOR_VERSION    != LPUART_UART_IP_SA_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (LPUART_UART_IP_CFG_AR_RELEASE_REVISION_VERSION != LPUART_UART_IP_SA_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Lpuart_Uart_Ip_Cfg.h and Lpuart_Uart_Ip_Sa_VS_0_PBcfg.h are different"
#endif
#if ((LPUART_UART_IP_CFG_SW_MAJOR_VERSION != LPUART_UART_IP_SA_VS_0_PBCFG_SW_MAJOR_VERSION) || \
     (LPUART_UART_IP_CFG_SW_MINOR_VERSION != LPUART_UART_IP_SA_VS_0_PBCFG_SW_MINOR_VERSION) || \
     (LPUART_UART_IP_CFG_SW_PATCH_VERSION != LPUART_UART_IP_SA_VS_0_PBCFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Lpuart_Uart_Ip_Cfg.h and Lpuart_Uart_Ip_Sa_VS_0_PBcfg.h are different"
#endif
...
#define LPUART_UART_IP_CONFIG_EXT \
     LPUART_UART_IP_SA_CONFIG_VS_0_PB \
