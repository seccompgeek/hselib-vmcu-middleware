 ...
 * Region 15: Only S32K388 and S32K389
*/
/*
+------+------------------+-----------------------------+------------------------------------------+----------------------------+-----------------------+------------------------+------------------------+------------+-------------+-------------------+---------------------+
| ID   | Region           | Start Address               | End Address                              | SizeKB                     | Type                  | Inner Cache Policy     | Outer Cache Policy     | Shareable  | Executable  | Privileged Access | Unprivileged Access |
+------+------------------+-----------------------------+------------------------------------------+----------------------------+-----------------------+------------------------+------------------------+------------+-------------+-------------------+---------------------+
| 0    | Whole memory map | 0x00000000                  | 0xFFFFFFFF                               | 4194304                    | Strongly Ordered      | None                   | None                   | Yes        | No          | No Access         | No Access           |
| 1    | ITCM (Lockstep)  | 0x00000000                  | 0x0000FFFF                               | 64                         | Strongly Ordered      | None                   | None                   | Yes        | Yes         | Read/Write        | No Access           |
| 1    | ITCM (Decoupled) | 0x00000000                  | 0x00007FFF                               | 32                         | Strongly Ordered      | None                   | None                   | Yes        | Yes         | Read/Write        | No Access           |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
----------------------------------------------------------------------------------------------S32K311/S32K341/S32M276/S32K310/S32M274------------------------------------------------------------------------------------------------------------------------------------------+
| 2    | Program Flash    | __ROM_CODE_START            | +1024KB - 1                              | 1024                       | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read-Only         | Read-Only           |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
----------------------------------------------------------------------------------------------S32K342/S32K312/S32K322----------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2    | Program Flash    | __ROM_CODE_START            | +2048KB - 1                              | 2048                       | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read-Only         | Read-Only           |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|---------------------------------------------------------------------------------------------Remaining Derivatives------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2    | Program Flash    | __ROM_CODE_START            | +4096KB - 1                              | 4096                       | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read-Only         | Read-Only           |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| 5    | DTCM (Lockstep)  | 0x20000000                  | 0x2001FFFF                               | 128                        | Normal                | None                   | None                   | No         | Yes         | Read/Write        | Read/Write          |
| 5    | DTCM (Decoupled) | 0x20000000                  | 0x2001FFFF                               | 64                         | Normal                | None                   | None                   | No         | Yes         | Read/Write        | Read/Write          |
----------------------------------------------------------------------------------------------S32K396/S32K394/S32K376/S32K374/S32K366/S32K364/S32K344/S32K324/S32K314----------------------------------------------------------------------------------------------------------+
| 6    | SRAM CACHE       | __INT_SRAM_START            | +(3/4 * __RAM_CACHEABLE_SIZE - 1)        | 3/4 * __RAM_CACHEABLE_SIZE | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read/Write        | Read/Write          |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|---------------------------------------------------------------------------------------------S32K396/S32K394/S32K376/S32K374/S32K366/S32K364 - Multicore Case-----------------------------------------------------------------------------------------------------------------+
| 6    | SRAM CACHE       | __INT_SRAM_START            | +__RAM_CACHEABLE_SIZE - 1                | __RAM_CACHEABLE_SIZE       | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read/Write        | Read/Write          |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------Remaining Derivatives-----------------------------------------------------------------------------------------------------------------------------------------------------------+
| 6    | SRAM CACHE       | __INT_SRAM_START            | +__RAM_CACHEABLE_SIZE - 1                | __RAM_CACHEABLE_SIZE       | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read/Write        | Read/Write          |
|      |                  |                                                                        |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------CCOV Testing for Low Ram Derivatives (S32K310/S32K311/S32M274/S32M276)----------------------------------------------------------------------------------------------------------+
| 6    | SRAM CACHE       | __INT_DTCM_START            | +__RAM_CACHEABLE_SIZE - 1                | __RAM_CACHEABLE_SIZE       | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read/Write        | Read/Write          |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------CCOV Testing for Low Ram Derivatives (S32K310/S32K311/S32M274/S32M276)----------------------------------------------------------------------------------------------------------+
| 7    | SRAM N-CACHE     | __INT_SRAM_START            | +__RAM_NO_CACHEABLE_SIZE - 1             | __RAM_NO_CACHEABLE_SIZE    | Normal                | None                   | None                   | Yes        | No          | Read/Write        | Read/Write          |
|      |                  |                                                                        |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------Remaining User cases------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 7    | SRAM N-CACHE     | __RAM_NO_CACHEABLE_START    | +__RAM_NO_CACHEABLE_SIZE - 1             | __RAM_NO_CACHEABLE_SIZE    | Normal                | None                   | None                   | Yes        | No          | Read/Write        | Read/Write          |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 8    | SRAM SHARED      | __RAM_SHAREABLE_START       | __RAM_SHAREABLE_SIZE - 1                 | __RAM_SHAREABLE_SIZE       | Normal                | None                   | None                   | Yes        | No          | Read/Write        | Read/Write          |
| 9    | AIPS_0/1/2       | 0x40000000                  | 0x405FFFFF                               | 6144                       | Strongly Ordered      | None                   | None                   | Yes        | No          | Read/Write        | Read/Write          |
|----------------------------------------------------------------------------------------------S32K396/S32K394/S32K374/S32K376/S32K364/S32K366)--------------------------------------------------------------------------------------------------------------------------------+
| 10   | AIPS_3           | 0x40600000                  | 0x407FFFFF                               | 2048                       | Strongly Ordered      | None                   | None                   | Yes        | No          | Read/Write        | Read/Write          |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------Remaining Derivatives-----------------------------------------------------------------------------------------------------------------------------------------------------------+
| 10   | AIPS_3           | N/A                         | N/A                                      | N/A                        | N/A                   | N/A                    | N/A                    | N/A        | N/A         | N/A               | N/A                 |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|----------------------------------------------------------------------------------------------S32K396/S32K376/S32K366/S32K356-------------------------------------------------------------------------------------------------------------------------------------------------+
| 14   | Program Flash 2  | __ROM_CODE_START + 0x400000 | +2048KB - 1                              | 2048                       | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read-Only         | Read-Only           |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------S32K358/S32K388/S32K328/S32K338/S32K348-----------------------------------------------------------------------------------------------------------------------------------------+
| 14   | Program Flash 2  | __ROM_CODE_START + 0x400000 | +4096KB - 1                              | 4096                       | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read-Only         | Read-Only           |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------S32K389 & MULIPLE IMAGE---------------------------------------------------------------------------------------------------------------------------------------------------------+
| 14   | Program Flash 2  | N/A                         | N/A                                      | N/A                        | N/A                   | N/A                    | N/A                    | N/A        | N/A         | N/A               | N/A                 |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------S32K389-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 14   | Program Flash 2  | __ROM_CODE_START + 0x400000 | +8192KB - 1                              | 8192                       | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | No         | Yes         | Read-Only         | Read-Only           |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------Remaining Derivatives-----------------------------------------------------------------------------------------------------------------------------------------------------------+
| 14   | Program Flash 2  | N/A                         | N/A                                      | N/A                        | N/A                   | N/A                    | N/A                    | N/A        | N/A         | N/A               | N/A                 |
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
...
|      |                  |                             |                                          |                            |                       |                        |                        |            |             |                   |                     |
|----------------------------------------------------------------------------------------------Remaining Derivatives-----------------------------------------------------------------------------------------------------------------------------------------------------------+
| 15   | ACE              | N/A                         | N/A                                      | N/A                        | N/A                   | N/A                    | N/A                    | N/A        | N/A         | N/A               | N/A                 |
+------+------------------+-----------------------------+------------------------------------------+----------------------------+-----------------------+------------------------+------------------------+------------+-------------+-------------------+---------------------+
*/
...
extern void HseSystemInit(void);
void SystemInit(void)
{
    ...
    switch(coreId)
    {
        case CM7_0:
            ...
            break;
        case CM7_1:
#if defined (S32K324) || defined (S32K358) || defined (S32K356) || defined(S32K328) || defined(S32K338) || defined(S32K348)
...
#if defined(S32K396) || defined(S32K376) || defined(S32K366)|| defined(S32K356)
...
#elif defined(S32K389)
    #if defined (MULTIPLE_IMAGE)
    rasr[14]=0UL;
    #else
    rasr[14]=0x070B002DUL;   /* Size: 8MB, Type: Normal, Inner Cache Policy: Inner write-back, write and read allocate, Outer Cache Policy: Outer write-back. write and read allocate, Shareable: No, Privileged Access: Read-Only, Unprivileged Access: Read-Only */
    #endif
#else
    rasr[14]=0UL;
#endif
