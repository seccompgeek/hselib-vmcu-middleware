...
/************************************************************************************/
/*                                   MAIN CORE GUIDE                                */
/* In S32K3xx/S32M27x, there are 4 cores. It is necessary to define the role of     */
/* each core. The main core plays the role of initializing the minimum              */
/* requirements for a multicore use case.                                           */
/*                                                                                  */
/* The main core is responsible for initializing data and BSS for binary            */
/* functioning, SRAM ECC, and shareable memory.                                     */
/*                                                                                  */
/* The MAIN_CORE macro specifies which core will be the main core in a multicore    */
/* use case.                                                                        */
/* Example: -DMAIN_CORE=<num_core> [0-3]                                            */
/* If the MAIN_CORE macro is not defined, the default is CM7_0.                     */
/************************************************************************************/
#ifndef MAIN_CORE
    #define MAIN_CORE 0
#endif
...
#define CORE_M7_3 3
    ...
    #if defined(CORE1)
        #define CURRENT_CORE CORE_M7_1
    #elif defined(CORE2)
        #define CURRENT_CORE CORE_M7_2
    #elif defined(CORE3)
        #define CURRENT_CORE CORE_M7_3
    #else
        /* CORE0 case or default */
        #define CURRENT_CORE CORE_M7_0
    #endif
    /* If this is a secodary core, it shall wait for the MSCM clock to be initialized */
    #if (MAIN_CORE != CURRENT_CORE)
