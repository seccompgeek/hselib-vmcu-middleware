...
#ifdef FLEXIO_MCL_IP_USE_SENT_MODULE
...
#define FLEXIO_MCL_IP_IRQ_SW_MAJOR_VERSION_C               6
...
#if defined(FLEXIO_MCL_IP_USE_UART_MODULE) || defined(FLEXIO_MCL_IP_USE_LIN_MODULE) || defined(FLEXIO_MCL_IP_USE_I2C_MODULE) || defined(FLEXIO_MCL_IP_USE_I2S_MODULE) || defined(FLEXIO_MCL_IP_USE_SPI_MODULE)
...
#if defined(FLEXIO_MCL_IP_USE_UART_MODULE) || defined(FLEXIO_MCL_IP_USE_I2C_MODULE) || defined(FLEXIO_MCL_IP_USE_I2S_MODULE) || defined(FLEXIO_MCL_IP_USE_PWM_MODULE) || defined(FLEXIO_MCL_IP_USE_SENT_MODULE)
