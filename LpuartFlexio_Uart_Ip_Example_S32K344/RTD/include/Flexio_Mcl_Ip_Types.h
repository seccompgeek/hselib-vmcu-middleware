...
#define FLEXIO_MCL_IP_TYPES_SW_MAJOR_VERSION                     6
...
/* Check if header file and Std_Types header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Flexio_Mcl_Ip_Types.h and Std_Types.h are different"
#endif
#endif
...
typedef struct
{
    const uint8                   NumOfInstanceConfig;
    const Flexio_Ip_InstanceConfigType (* const pInstanceConfig)[];
} Flexio_Ip_InstanceInitType;
/*==================================================================================================
                                     FUNCTION PROTOTYPES
==================================================================================================*/
