...
#define FLEXIO_UART_IP_TYPES_SW_MAJOR_VERSION             6
...
typedef struct
{
    uint8 Instance;                                /**< @brief Flexio Uart Instance has been configured. */
    uint8 Channel;                                /**< @brief Flexio Uart Channel has been configured. Note that Make sure
